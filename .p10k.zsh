# Generated by Powerlevel10k configuration wizard on 2025-09-30 at 21:06 NZDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#3e6fd9'
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#da4453'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#6084d2'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND='#27ae60'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND='#da4453'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND='#da4453'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND='#da4453'

  ###################[ command_execution_time: duration of the last command ]###################
  # Execution time color.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=255
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#da4453'
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND='#6084d2'
